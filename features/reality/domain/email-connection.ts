 ...
 *  tenga que cambiar. */
export type { EmailConnection, EmailConnectionStatus } from "../../../core/email-connections/domain";
export { EMAIL_CONNECTION_STATUSES } from "../../../core/email-connections/domain";
