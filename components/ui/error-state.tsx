  ...
  return (
    ...
    >
      <div className="animate-fade-in">
        ...
        <button
          onClick={onRetry}
          className="mt-8 rounded-full bg-white px-8 py-3 font-medium text-black transition hover:bg-zinc-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-luz"
        >
          Intentar de nuevo
        </button>
      </div>
