...
--> statement-breakpoint
ALTER TABLE "conversation_messages" ADD COLUMN "user_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "evidence" ADD COLUMN "user_id" uuid NOT NULL;--> statement-breakpoint
...
CREATE INDEX "evidence_user_id_idx" ON "evidence" USING btree ("user_id");