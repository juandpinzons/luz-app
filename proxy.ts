...
/**
 * Protege /chat, /dashboard, /admin, /feedback, /calendar (UI) y
 * /api/chat, /api/feedback, /api/calendar (API) exigiendo sesión. La
 * landing (`/`) y `/login` quedan públicas a propósito.
